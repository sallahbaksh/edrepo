<?php /* Smarty version Smarty-3.0.7, created on 2014-07-22 11:52:15
         compiled from "E:\XAMPP\xampplite-win32-1.7.3\xampplite\htdocs\xampp\EdRepo\EdRepo\lib\smarty/templates/moduleWizard/basics.php.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2500453ce88af887986-03291082%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ffb5ed9ac14fb83c37778f4ee8a05e0f1b539020' => 
    array (
      0 => 'E:\\XAMPP\\xampplite-win32-1.7.3\\xampplite\\htdocs\\xampp\\EdRepo\\EdRepo\\lib\\smarty/templates/moduleWizard/basics.php.tpl',
      1 => 1406042638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2500453ce88af887986-03291082',
  'function' => 
  array (
  ),
...
"></input>
    ...
    <div class="fieldRow">
      ...
      <div class="fieldInput">
        <input<?php if ($_smarty_tpl->getVariable('moduleAction')->value=="createNewVersion"||$_smarty_tpl->getVariable('moduleAction')->value=="edit"){?> disabled="disabled" title="Module title cannot be changed after creation."<?php }?>  type="text" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('moduleInfo')->value['title'])===null||$tmp==='' ? '' : $tmp);?>
" name="moduleTitle" /> 
      </div>
    </div>
	...
	<div class="fieldRow">
		...
		<select name="restrictions" size="1">
			...
			<option value="Temp" <?php if (isset($_smarty_tpl->getVariable('moduleInfo',null,true,false)->value['restrictions'])&&$_smarty_tpl->getVariable('moduleInfo')->value['restrictions']=="Temp"){?> selected="selected"<?php }?>>Temp</option>
...
"></input><br />
    ...
    <fieldset class="buttons">
	  ...
	  <a class="button" href="index.php?moduleAction=createNewVersion&moduleID=<?php echo $_smarty_tpl->getVariable('moduleID')->value;?>
">Create A New Version</a> | 
