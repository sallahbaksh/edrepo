<?php /* Smarty version Smarty-3.0.7, created on 2014-07-22 14:57:07
         compiled from "E:\XAMPP\xampplite-win32-1.7.3\xampplite\htdocs\xampp\EdRepo\EdRepo\lib\smarty/templates/browse.php.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1254653ceb403c0f2a7-07343834%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '16b71d0b34541b539e7e821106f5c7bf2f07a0ca' => 
    array (
      0 => 'E:\\XAMPP\\xampplite-win32-1.7.3\\xampplite\\htdocs\\xampp\\EdRepo\\EdRepo\\lib\\smarty/templates/browse.php.tpl',
      1 => 1406055398,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1254653ceb403c0f2a7-07343834',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_date_format')) include 'E:\XAMPP\xampplite-win32-1.7.3\xampplite\htdocs\xampp\EdRepo\EdRepo\lib\smarty\plugins\modifier.date_format.php';
?>
...
" />
    ...
    <fieldset class="clearable">
      <h3>General</h3>
      <ul class="checkboxes">
        <li><label><input type="checkbox" name="topLevel" value="*"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['topLevel'])&&$_smarty_tpl->getVariable('filters')->value['topLevel']){?> checked="checked"<?php }?>/> Show only top-level modules</label><label><?php  $_smarty_tpl->tpl_vars['module'] = new Smarty_Variable;
...
?><?php if (amountTopLevel($_smarty_tpl->tpl_vars['module']->value['ID'])>0){?> (<?php echo amountTopLevel($_smarty_tpl->tpl_vars['module']->value['ID']);?>
) <?php }?><?php }} ?></label></li>
        <li><label><input type="checkbox" name="hasMaterial" value="*"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['hasMaterial'])&&$_smarty_tpl->getVariable('filters')->value['hasMaterial']){?> checked="checked"<?php }?>/> Show only modules with materials</label><label><?php  $_smarty_tpl->tpl_vars['module'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('filters')->value['hasMaterial']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['module']->key => $_smarty_tpl->tpl_vars['module']->value){
?><?php if (amountHasMaterial($_smarty_tpl->tpl_vars['module']->value['ID'])>0){?> (<?php echo amountHasMaterial($_smarty_tpl->tpl_vars['module']->value['ID']);?>
) <?php }?><?php }} ?></label></li>
      </ul>
    </fieldset>      
  ...
  <?php if ($_smarty_tpl->getVariable('useCategories')->value=="true"){?>
    <fieldset>
      ...
      <ul class="checkboxes hasAny">
        <li><label><input class="any" type="checkbox" name="moduleCategory[]" value="*"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['category'])&&in_array("*",$_smarty_tpl->getVariable('filters')->value['category'])){?> checked="checked"<?php }?>/> Any</label><label><?php if (amountOfModules('')>0){?> (<?php echo amountOfModules('');?>
) <?php }?></label></li>
...
"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['category'])&&in_array($_smarty_tpl->tpl_vars['category']->value['ID'],$_smarty_tpl->getVariable('filters')->value['category'])){?> checked="checked"<?php }?>> <?php echo $_smarty_tpl->tpl_vars['category']->value['name'];?>
</label><label><?php if (amountOfModuleInCategories($_smarty_tpl->tpl_vars['category']->value['ID'])>0){?> (<?php echo amountOfModuleInCategories($_smarty_tpl->tpl_vars['category']->value['ID']);?>
) <?php }?></label></li>
        <?php }} ?>
      </ul>
    </fieldset>      
  ...
  <?php if ($_smarty_tpl->getVariable('useTypes')->value=="true"){?>
    <fieldset>
      <h3>Type</h3>
      <ul class="checkboxes hasAny">
        <li><label><input class="any" type="checkbox" name="moduleType[]" value="*"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['type'])&&in_array("*",$_smarty_tpl->getVariable('filters')->value['type'])){?> checked="checked"<?php }?>/> Any</label><label><?php if (amountOfModules('')>0){?> (<?php echo amountOfModules('');?>
) <?php }?></label></li>
...
"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['type'])&&in_array($_smarty_tpl->tpl_vars['type']->value['ID'],$_smarty_tpl->getVariable('filters')->value['type'])){?> checked="checked"<?php }?>> <?php echo $_smarty_tpl->tpl_vars['type']->value['name'];?>
</label><label><?php if (amountOfModuleInTypes($_smarty_tpl->tpl_vars['type']->value['ID'])>0){?> (<?php echo amountOfModuleInTypes($_smarty_tpl->tpl_vars['type']->value['ID']);?>
) <?php }?></label></li>
        <?php }} ?>
      </ul>
    </fieldset>      
  ...
  <?php if ($_smarty_tpl->getVariable('adminOrEditor')->value){?>
    <fieldset>
      <h3>Status</h3>
      <ul class="checkboxes hasAny">
        <li><label><input class="any" type="checkbox" name="moduleStatus[]" value="*"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['status'])&&in_array("*",$_smarty_tpl->getVariable('filters')->value['status'])){?> checked="checked"<?php }?>/> Any</label><label><?php if (amountOfModules('')>0){?> (<?php echo amountOfModules('');?>
) <?php }?></label></li>
        <li><label><input type="checkbox" name="moduleStatus[]" value="Active"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['status'])&&in_array("Active",$_smarty_tpl->getVariable('filters')->value['status'])){?> checked="checked"<?php }?>> Active</label><label><?php if (amountOfModuleInStatus("Active")>0){?> (<?php echo amountOfModuleInStatus("Active");?>
) <?php }?></label></li>
        <li><label><input type="checkbox" name="moduleStatus[]" value="InProgress"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['status'])&&in_array("InProgress",$_smarty_tpl->getVariable('filters')->value['status'])){?> checked="checked"<?php }?>> InProgress</label><label><?php if (amountOfModuleInStatus("InProgress")>0){?> (<?php echo amountOfModuleInStatus("InProgress");?>
) <?php }?></label></li>
        <li><label><input type="checkbox" name="moduleStatus[]" value="PendingModeration"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['status'])&&in_array("PendingModeration",$_smarty_tpl->getVariable('filters')->value['status'])){?> checked="checked"<?php }?>> PendingModeration</label><label><?php if (amountOfModuleInStatus("PendingModeration")>0){?> (<?php echo amountOfModuleInStatus("PendingModeration");?>
) <?php }?></label></li>
        <li><label><input type="checkbox" name="moduleStatus[]" value="Locked"<?php if (isset($_smarty_tpl->getVariable('filters',null,true,false)->value['status'])&&in_array("Locked",$_smarty_tpl->getVariable('filters')->value['status'])){?> checked="checked"<?php }?>> Locked</label><label><?php if (amountOfModuleInStatus("Locked")>0){?> (<?php echo amountOfModuleInStatus("Locked");?>
) <?php }?></label></li>
      </ul>
    </fieldset>      
  <?php }?> 
